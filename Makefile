...
SOURCES = \
	__init__.py \
	qgis_to_ugcs.py qgis_to_ugcs_dialog.py

PLUGINNAME = qgis_to_ugcs

PY_FILES = \
	__init__.py \
	qgis_to_ugcs.py qgis_to_ugcs_dialog.py

UI_FILES = qgis_to_ugcs_dialog_base.ui
...
QGISDIR=C:\Users\VincentBenet\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
