...
class QgisToUGCS:
    ...
    def __init__(self, iface):
        ...
        self.actions = []
        self.menu = self.tr(u'&QgisToUGCS')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('QgisToUGCS', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/qgis_to_ugcs/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'QGIS to UGCS'),
            callback=self.run,
